// /api/outline.js
// Unlimited outline generation (no limits enforced)
...
`.trim();
    ...
    if (!parsed.title || !parsed.purpose || !Array.isArray(parsed.outline)) {
      return res.status(500).json({ error: "Malformed outline response" });
    }
